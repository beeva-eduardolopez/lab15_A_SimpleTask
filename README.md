...
Lab 15a - Redo the simple tasks lab, this time setting up a basic Angular site with one view. 
You cannot use any DOM functions (document., etc) or JQuery. 
You should use $scope, ng-model, ng-repeat, ng-click, etc.
